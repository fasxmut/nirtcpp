...
#ifndef NIRT_C_SCENE_MANAGER_H_INCLUDED
#define NIRT_C_SCENE_MANAGER_H_INCLUDED
...
namespace scene
{
	...
	*/
	...
	public:
		...
		virtual IAnimatedMesh* getMesh(const io::path& filename, const io::path& alternativeCacheName) override;
		...
		virtual IMeshSceneNode* addCubeSceneNode(f32 size=10.0f, ISceneNode* parent=0, s32 id=-1,
			...
			ECUBE_MESH_TYPE type=ECMT_1BUF_12VTX_NA) override;
		...
		virtual void clearAllRegisteredNodesForRendering() override;
		...
		virtual ICameraSceneNode* addCameraSceneNodeFPS(ISceneNode* parent = 0,
			...
			bool invertMouseY=false, bool makeActive=true) override;
		...
		*/
		virtual ISceneNodeAnimator* createFlyCircleAnimator(
				...
				f32 radiusEllipsoid = 0.f) override;

		//! Creates a fly straight animator, which lets the attached scene node
		//! fly or move along a line between two points.
		virtual ISceneNodeAnimator* createFlyStraightAnimator(const core::vector3df& startPoint,
			const core::vector3df& endPoint, u32 timeForWay, bool loop=false,bool pingpong = false) override;

		//! Creates a texture animator, which switches the textures of the target scene
		//! node based on a list of textures.
		virtual ISceneNodeAnimator* createTextureAnimator(const core::array<video::ITexture*>& textures,
			s32 timePerFrame, bool loop) override;

		//! Creates a scene node animator, which deletes the scene node after
		//! some time automatically.
		virtual ISceneNodeAnimator* createDeleteAnimator(u32 timeMS) override;
		...
		virtual ISceneNodeAnimatorCollisionResponse* createCollisionResponseAnimator(
			...
			f32 slidingValue = 0.0005f) override;

		//! Creates a follow spline animator.
		virtual ISceneNodeAnimator* createFollowSplineAnimator(s32 startTime,
			const core::array< core::vector3df >& points,
			f32 speed, f32 tightness, bool loop, bool pingpong, bool steer) override;
		...
		virtual const c8* getAnimatorTypeName(ESCENE_NODE_ANIMATOR_TYPE type) override;
		...
		virtual void registerSceneNodeAnimatorFactory(ISceneNodeAnimatorFactory* factoryToAdd) override;
		...
		virtual bool saveScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer=0, ISceneNode* node=0) override;

		//! Saves the current scene into a file.
		virtual bool saveScene(io::IWriteFile* file, ISceneUserDataSerializer* userDataSerializer=0, ISceneNode* node=0) override;

		//! Saves the current scene into a file.
		virtual bool saveScene(io::IXMLWriter* writer, const io::path& currentPath, ISceneUserDataSerializer* userDataSerializer=0, ISceneNode* node=0) override;

		//! Loads a scene. Note that the current scene is not cleared before.
		virtual bool loadScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer=0, ISceneNode* rootNode=0) override;
