...
#ifndef NIRT_C_IMAGE_LOADER_TGA_H_INCLUDED
#define NIRT_C_IMAGE_LOADER_TGA_H_INCLUDED
...
#if defined(_NIRT_COMPILE_WITH_TGA_LOADER_) || defined(_NIRT_COMPILE_WITH_TGA_WRITER_)
