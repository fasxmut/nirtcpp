...
#ifndef NIRT_C_DEFAULT_SCENE_NODE_FACTORY_H_INCLUDED
#define NIRT_C_DEFAULT_SCENE_NODE_FACTORY_H_INCLUDED
...
namespace scene
{
	...
	public:
		...
		virtual u32 getCreatableSceneNodeTypeCount() const override;
