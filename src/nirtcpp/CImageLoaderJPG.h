...
#ifndef NIRT_C_IMAGE_LOADER_JPG_H_INCLUDED
#define NIRT_C_IMAGE_LOADER_JPG_H_INCLUDED
...
extern "C" {
	...
	#else
	#include "jpeglib/jpeglib.h" // use nirtcpp jpeglib
	#endif
	#include <setjmp.h>
}
...
private:
	...
	*/
	...
	/* output error messages via Nirtcpp logger. */
