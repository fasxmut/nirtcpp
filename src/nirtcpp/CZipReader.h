...
#ifndef NIRT_C_ZIP_READER_H_INCLUDED
#define NIRT_C_ZIP_READER_H_INCLUDED
...
*/
	...
	public:
		...
		virtual E_FILE_ARCHIVE_TYPE getType() const override;
...
#endif // NIRT_C_ZIP_READER_H_INCLUDED
