...
/*
  ...
  This loader is used to load DMF files in Nirtcpp.
  ...
  please refer to COCTLoader.hpp to know more about rights granted.
...
#ifndef NIRT_C_DMF_LOADER_H_INCLUDED
#define NIRT_C_DMF_LOADER_H_INCLUDED
...
namespace scene
{
	...
	public:
		...
		Nirtcpp correctly loads specular color, diffuse color , position and distance of object affected by light.
		...
		Nirtcpp correctly loads position and rotation of water plain as well as texture layers.
