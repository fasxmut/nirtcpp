...
#ifndef NIRT_C_WAD_READER_H_INCLUDED
#define NIRT_C_WAD_READER_H_INCLUDED
...
#include <nirtcpp/irrunpack.hpp>
	...
	public:
		...
		//! get the class Type
		virtual E_FILE_ARCHIVE_TYPE getType() const override { return EFAT_WAD; }
...
#endif	// #ifdef __NIRT_COMPILE_WITH_WAD_ARCHIVE_LOADER_
