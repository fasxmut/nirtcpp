...
#ifndef NIRT_C_IMAGE_LOADER_BMP_H_INCLUDED
#define NIRT_C_IMAGE_LOADER_BMP_H_INCLUDED
...
#if defined(_NIRT_COMPILE_WITH_BMP_LOADER_) || defined(_NIRT_COMPILE_WITH_BMP_WRITER_)
