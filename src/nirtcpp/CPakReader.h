...
#ifndef NIRT_C_PAK_READER_H_INCLUDED
#define NIRT_C_PAK_READER_H_INCLUDED
...
namespace io
{
	...
	public:
		...
		//! get the class Type
		virtual E_FILE_ARCHIVE_TYPE getType() const override { return EFAT_PAK; }
...
#endif // NIRT_C_PAK_READER_H_INCLUDED
