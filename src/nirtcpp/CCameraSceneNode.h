...
#ifndef NIRT_C_CAMERA_SCENE_NODE_H_INCLUDED
#define NIRT_C_CAMERA_SCENE_NODE_H_INCLUDED
...
namespace scene
{
	...
	public:
		...
		virtual const SViewFrustum* getViewFrustum() const override;
		...
		virtual ESCENE_NODE_TYPE getType() const override { return ESNT_CAMERA; }
