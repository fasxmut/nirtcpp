...
#ifndef NIRT_C_NIRT_DEVICE_LINUX_H_INCLUDED
#define NIRT_C_NIRT_DEVICE_LINUX_H_INCLUDED
...
namespace nirt
{
	...
	public:
		...
		//! constructor
		CIrrDeviceLinux(const SNirtcppCreationParameters& param);
...
#ifdef _NIRT_COMPILE_WITH_X11_
		// convert an Nirtcpp texture to a X11 cursor
		Cursor TextureToCursor(nirt::video::ITexture * tex, const core::rect<s32>& sourceRect, const core::position2d<s32> &hotspot);
		Cursor TextureToMonochromeCursor(nirt::video::ITexture * tex, const core::rect<s32>& sourceRect, const core::position2d<s32> &hotspot);
#ifdef _NIRT_LINUX_XCURSOR_
		Cursor TextureToARGBCursor(nirt::video::ITexture * tex, const core::rect<s32>& sourceRect, const core::position2d<s32> &hotspot);
#endif
#endif
...
// So also workaround for Nirtcpp bug #450
#ifdef _NIRT_LINUX_X11_XINPUT2_
						if ( DeviceId != 0)
						{
			...
			virtual gui::ECURSOR_ICON addIcon(const gui::SCursorSprite& icon) override;

			//! replace the given cursor icon.
			virtual void changeIcon(gui::ECURSOR_ICON iconId, const gui::SCursorSprite& icon) override;

			//! Return a system-specific size which is supported for cursors. Larger icons will fail, smaller icons might work.
			virtual core::dimension2di getSupportedIconSize() const override;

#ifdef _NIRT_COMPILE_WITH_X11_
			//! Set platform specific behavior flags.
			virtual void setPlatformBehavior(gui::ECURSOR_PLATFORM_BEHAVIOR behavior) override {PlatformBehavior = behavior; }

			//! Return platform specific behavior.
			virtual gui::ECURSOR_PLATFORM_BEHAVIOR getPlatformBehavior() const override { return PlatformBehavior; }
...
#endif // NIRT_C_NIRT_DEVICE_LINUX_H_INCLUDED
