...
#ifndef NIRT_I_BILLBOARD_SCENE_NODE_H_INCLUDED
#define NIRT_I_BILLBOARD_SCENE_NODE_H_INCLUDED
...
public:
	...
	*/
	...
	virtual const core::aabbox3d<f32>& getTransformedBillboardBoundingBox(const nirt::scene::ICameraSceneNode* camera) = 0;
