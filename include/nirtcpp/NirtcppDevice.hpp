...
#include <nirtcpp/EDeviceTypes.hpp>
...
namespace nirt
{
	...
	*/
	...
	public:
		...
		then. See nirt::SNirtcppCreationParameters::WindowId for more
		...
		*/
		...
		on its type. See nirt::EEVENT_TYPE for details.
		...
		*/
		...
		activate joystick support in Nirtcpp and to receive nirt::SJoystickEvent events.
