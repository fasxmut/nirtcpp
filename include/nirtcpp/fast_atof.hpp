...
// For conditions of distribution and use, see copyright notice in nirtcpp/nirtcpp.hpp and irrXML.h

#ifndef NIRT_FAST_ATOF_H_INCLUDED
#define NIRT_FAST_ATOF_H_INCLUDED
...
namespace core
{
	...
	//! By default Nirtcpp considers "." as the decimal point in numbers.
...
inline const char* fast_atof_move(const char* in, f32& result)
{
	...
	if ( LOCALE_DECIMAL_POINTS.findFirst(*in) >= 0 )
	{
		...
		if (numDecimals < NIRT_ATOF_TABLE_SIZE)
		{
