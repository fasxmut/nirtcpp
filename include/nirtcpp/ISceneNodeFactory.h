...
#ifndef NIRT_I_SCENE_NODE_FACTORY_H_INCLUDED
#define NIRT_I_SCENE_NODE_FACTORY_H_INCLUDED
...
namespace scene
{
	...
	/** To be able to add custom scene nodes to Nirtcpp and to make it possible for the
