...
#ifndef NIRT_I_PARTICLE_GRAVITY_AFFECTOR_H_INCLUDED
#define NIRT_I_PARTICLE_GRAVITY_AFFECTOR_H_INCLUDED
...
public:
	...
	//! Get emitter type
	virtual E_PARTICLE_AFFECTOR_TYPE getType() const override { return EPAT_GRAVITY; }
};

} // end namespace scene
} // end namespace nirt

#endif // NIRT_I_PARTICLE_GRAVITY_AFFECTOR_H_INCLUDED
