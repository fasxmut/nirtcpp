...
#ifndef NIRT_I_GPU_PROGRAMMING_SERVICES_H_INCLUDED
#define NIRT_I_GPU_PROGRAMMING_SERVICES_H_INCLUDED

#include <nirtcpp/EShaderTypes.hpp>
#include <nirtcpp/EMaterialTypes.hpp>
#include <nirtcpp/EPrimitiveTypes.hpp>
