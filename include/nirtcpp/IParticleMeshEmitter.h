...
#ifndef NIRT_I_PARTICLE_MESH_EMITTER_H_INCLUDED
#define NIRT_I_PARTICLE_MESH_EMITTER_H_INCLUDED
...
public:
	...
	//! Get emitter type
	virtual E_PARTICLE_EMITTER_TYPE getType() const override { return EPET_MESH; }
};
