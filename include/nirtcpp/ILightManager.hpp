...
#ifndef NIRT_I_LIGHT_MANAGER_H_INCLUDED
#define NIRT_I_LIGHT_MANAGER_H_INCLUDED

#include <nirtcpp/IReferenceCounted.hpp>
#include <nirtcpp/irrArray.hpp>
#include <nirtcpp/ISceneManager.hpp> // for E_SCENE_NODE_RENDER_PASS, could probably move that to own header?
