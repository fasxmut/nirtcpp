...
#ifndef NIRT_LINE_2D_H_INCLUDED
#define NIRT_LINE_2D_H_INCLUDED
...
class line2d
{
	...
	template <>
	inline vector2df line2d<nirt::f32>::getClosestPoint(const vector2df& point, bool checkOnlySegments) const
	{
